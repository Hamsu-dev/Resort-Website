...
const Booking = () => {
  return (
    <div id='booking' className='max-w-[1140px] m-auto w-full p-4'>
      <h2 className='text-center text-gray-700 p-4'>Booking</h2>
      <form className='lg:flex lg:justifiy-between w-full items-center'>
        <div className='flex flex-col my-2 py-2'>
          <label>Destination</label>
          <select className='lg:w-[300px] md:w-full border rounded-md p-2'>
            <option>The Ritz-Carlton</option>
            <option>Belmond Hotel Caruso</option>
            <option>The Aman</option>
            <option>The Farm at Cape Kidnappers</option>
          </select>
        </div>
